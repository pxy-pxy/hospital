...
public class CashierController {
    ...
    public Object look(Model model){
        //查询所有药房
        List<Warehuose> selware = cashierService.selware();
    ...
    @ResponseBody
    public Object addchu(Cashier cCashier,Pharmacy pharmacy){
        //向处方添加药品
        Integer addchu = cashierService.addchu(cCashier);
